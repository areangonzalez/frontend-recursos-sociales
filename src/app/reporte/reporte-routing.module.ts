...
import { RecursoSocialService } from '../core/services';
...
const routes: Routes = [
    {
        ...
        children: [
          ...
          { path: 'prestaciones', component: PrestacionesComponent, data: { breadcrumb: 'Prestaciones' }, resolve: { prestaciones: RecursoSocialService } },
